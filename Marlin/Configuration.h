...
#define STRING_CONFIG_H_AUTHOR "(jccit, default config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 139.72
  #define DEFAULT_bedKi 27.24
  #define DEFAULT_bedKd 477.85
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -7, -3.6 }
